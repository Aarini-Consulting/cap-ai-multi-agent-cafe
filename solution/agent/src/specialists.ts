...
import { cafeTools, kitchenTools, grievanceTools } from "./tools.js";
...
export async function runCafeAssistant(context: string): Promise<string> {
  console.log("  [Café Assistant] Working...");
...
export async function runKitchenManager(context: string): Promise<string> {
...
export async function runGrievanceManager(context: string): Promise<string> {
