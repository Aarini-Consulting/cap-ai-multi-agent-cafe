...
console.log("Café Multi-Agent Assistant");
console.log("=========================");
console.log("Three agents work together to serve you:");
console.log("  - Café Assistant (orders, menu, recommendations)");
...
console.log('Try: "What vegan options do you have?" (normal request)');
console.log("");
...
function prompt() {
  rl.question("You: ", async (input) => {
    ...
    if (!trimmed || trimmed.toLowerCase() === "exit") {
      console.log("Thanks for visiting the café!");
      rl.close();
      return;
    }
