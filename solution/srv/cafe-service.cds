...
@description: 'Café service with stock management and customer feedback. Supports multi-agent orchestration: Café Assistant handles orders, Kitchen Manager handles restocking, Grievance Manager handles complaints.'
@path: '/api/cafe'
...
service CafeService {
  ...
  @description: 'The full café menu with stock quantities and availability'
  ...
  @description: 'Invoke the multi-agent orchestrator. Routes the message to the appropriate specialist (Café Assistant, Kitchen Manager, or Grievance Manager) and returns the final response.'
  action invokeAgent(
