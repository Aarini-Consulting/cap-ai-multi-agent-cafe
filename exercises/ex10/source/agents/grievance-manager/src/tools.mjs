...
/**
 * Creates grievance manager tools that call the CAP service via HTTP
...
export function createGrievanceTools(capServiceUrl, authToken) {
  ...
  const getFeedbackDetails = tool(
    async ({ feedbackId }) => get(`/api/cafe/getFeedbackDetails(feedbackId='${encodeURIComponent(feedbackId)}')`),
